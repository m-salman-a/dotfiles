...
vim.keymap.set("n", "<Leader>fd", ":Telescope diagnostics initial_mode=normal<CR>", opts)
vim.keymap.set("n", "<Leader>fs", ":Telescope treesitter initial_mode=normal<CR>", opts)
vim.keymap.set("n", "<Leader>ft", ":TodoTelescope initial_mode=normal<CR>", opts)
